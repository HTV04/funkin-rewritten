...
So, out of boredom, and since I want to give myself a challenge as an apsiring game developer, I decided to rewrite *Friday Night Funkin'* from scratch. I wanted to choose a framework that I was more familiar with and felt had good performance (no offense, *HaxeFlixel*), so I chose *LÖVE*, a very powerful framework for 2D games that uses Lua as its programming language.

After about a week's worth of work on the game, I finished the first beta version of *Friday Night Funkin' Rewritten*! I designed it to feel and play as close to the original engine as possible, while fixing the above issues. It's currently in beta, so it isn't finished yet. Try it out, and give me feedback on how I can improve it!
