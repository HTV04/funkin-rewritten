...
return {
	...
	initUI = function(self)
		...
		sprites["left arrow"] = love.filesystem.load("sprites/pixel/left-arrow.lua")
		sprites["down arrow"] = love.filesystem.load("sprites/pixel/down-arrow.lua")
		sprites["up arrow"] = love.filesystem.load("sprites/pixel/up-arrow.lua")
		sprites["right arrow"] = love.filesystem.load("sprites/pixel/right-arrow.lua")
